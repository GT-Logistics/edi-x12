...
/**
 * @property FunctionalIdentifierCode $GS01 Code identifying a group of application related transaction sets
 ...
 * @property ResponsibleAgencyCode $GS07 Code identifying the issuer of the standard; this code is used in conjunction with Data Element 480
 * @property VersionReleaseIndustryIdentifierCode $GS08 Code indicating the version, release, and industry identifier of the EDI Standard being used, including the GS and GE segments; if the code in DE455 in the GS segment is X, then DE 480 positions 1-3 are the version number; positions 4-6 are the release level of the version; and positions 7-12 are the industry or trade association identifiers (optionally assigned by user); if the code in DE455 in the GS segment is T, other formats are allowed.
 */
